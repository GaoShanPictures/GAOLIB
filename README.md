...
- When the Gaolib window is opened, DO NOT TRY TO RESIZE OR MOVE ANY BLENDER WINDOW, as it may freeze Blender. Resizing Gaolib itself may work without causing any issues.
