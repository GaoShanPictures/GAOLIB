...
# Form implementation generated from reading ui file 'C:\Users\anneb\Documents\GAO_PIPELINE\GAOLIB\gaolib\ui\createposewidget.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.previewWidget = QtWidgets.QWidget(Form)
        self.previewWidget.setObjectName("previewWidget")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.previewWidget)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setSpacing(0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.refreshSelectionPushButton_3 = QtWidgets.QPushButton(self.previewWidget)
        self.refreshSelectionPushButton_3.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap("icons/refresh.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        self.refreshSelectionPushButton_3.setIcon(icon1)
        self.refreshSelectionPushButton_3.setObjectName("refreshSelectionPushButton_3")
        self.gridLayout_3.addWidget(self.refreshSelectionPushButton_3, 0, 2, 1, 1)
        self.contentLabel_2 = QtWidgets.QLabel(self.previewWidget)
        self.contentLabel_2.setText("")
        self.contentLabel_2.setObjectName("contentLabel_2")
        self.gridLayout_3.addWidget(self.contentLabel_2, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.refreshSelectionPushButton_3.setToolTip(
            _translate("Form", "Refresh selection preview")
        )
