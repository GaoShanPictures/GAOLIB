...
"")
        ...
        self.ffmpegPathLlineEdit = QtWidgets.QLineEdit(self.widget)
        self.ffmpegPathLlineEdit.setMinimumSize(QtCore.QSize(0, 25))
        self.ffmpegPathLlineEdit.setText("")
        self.ffmpegPathLlineEdit.setObjectName("ffmpegPathLlineEdit")
        self.verticalLayout_2.addWidget(self.ffmpegPathLlineEdit)
        ...
        self.itemsInTreeCheckBox = QtWidgets.QCheckBox(self.widget)
        self.itemsInTreeCheckBox.setObjectName("itemsInTreeCheckBox")
        self.verticalLayout_2.addWidget(self.itemsInTreeCheckBox)
        ...
        self.doubleClickPoseShortcutCheckBox.setObjectName("doubleClickPoseShortcutCheckBox")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_7.setText(_translate("Dialog", "FFMPEG Path"))
        self.ffmpegPathLlineEdit.setPlaceholderText(_translate("Dialog", "C:/Users/login/Documents/ffmpeg/bin/ffmpeg.exe"))
        self.label_5.setText(_translate("Dialog", "Item Display Mode"))
        self.recursiveListModeCheckBox.setText(_translate("Dialog", "Display all items contained in subfolders recursively (main view)"))
        self.itemsInTreeCheckBox.setText(_translate("Dialog", "Display items in folder hierarchy (tree view)"))
        self.label_6.setText(_translate("Dialog", "Shortcuts"))
        self.doubleClickPoseShortcutCheckBox.setText(_translate("Dialog", "Use double click on POSE items to apply  pose to 100%"))
        self.blendPoseOnWheelCheckBox.setText(_translate("Dialog", "Keep wheel pressed and drag mouse on POSE items to blend pose"))