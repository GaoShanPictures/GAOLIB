...
# "import" statement.
dependencies = (Dependency(module="PySide2", package=None, name=None), Dependency(module="imageio", package=None, name=None), Dependency(module="PIL", package=None, name=None),)
